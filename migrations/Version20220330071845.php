 ...
 */
final class Version20220330071845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `client` (`idCl` int(3) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY,`nomCl` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,`AdrCl` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,`EmailCl` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,`client_sup` tinyint(1) NOT NULL DEFAULT 0, `nif` VARCHAR(20), `cif` VARCHAR(20), `stat` VARCHAR(20), `RCS` VARCHAR(20)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;');
        // ---- Structure de la table `frs`
        $this->addSql('CREATE TABLE `frs` (`idF` int(3) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY,`nomf` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,`AdrF` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,`EmailF` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,`frs_sup` tinyint(1) DEFAULT NULL,  `nif` VARCHAR(20), `cif` VARCHAR(20), `stat` VARCHAR(20), `RCS` VARCHAR(20)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;');
        // ---- Structure de la table `produit`
        $this->addSql('CREATE TABLE `produit` (`idProd` int(3) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY,`RefProduit` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL UNIQUE,`desProduit` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,`photo`varchar(255) COLLATE utf8mb4_unicode_ci,`PrixAP` int(10) UNSIGNED NOT NULL,`PrixVP` int(10) UNSIGNED NOT NULL,`prod_sup` tinyint(1) DEFAULT NULL,`SeuilAp` int(10) UNSIGNED NOT NULL,`idFamille` int(10) UNSIGNED DEFAULT NULL,`idU` int(10) UNSIGNED DEFAULT NULL, `idF` int(3) UNSIGNED ZEROFILL,CONSTRAINT `FK_29A5EC2734CA99E1` FOREIGN KEY (`idFamille`) REFERENCES `famille` (`idFamille`),CONSTRAINT `FK_29A5EC27A2D72265` FOREIGN KEY (`idU`) REFERENCES `unite` (`idU`), CONSTRAINT `fk_produit_frs` FOREIGN KEY (`idF`) REFERENCES  `frs`(`idF`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;');
        ...
        $this->addSql('CREATE TABLE `vente` (`numV` int(6) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY,`dateV` date NOT NULL,`idCl` int(3) UNSIGNED ZEROFILL DEFAULT NULL,`Tvav` float(4,2) UNSIGNED ZEROFILL NOT NULL,CONSTRAINT `fk_vente_client` FOREIGN KEY (`idCl`) REFERENCES `client` (`idCl`), `attente` tinyint(1) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;');
        // ---- Structure de la table `achat`
        $this->addSql('CREATE TABLE `achat` (`numA` int(6) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY,`dateA` date NOT NULL,`idF` int(3) UNSIGNED ZEROFILL NOT NULL,`tvaA` float(4,2) UNSIGNED ZEROFILL NOT NULL,CONSTRAINT `fk_achat_frs` FOREIGN KEY (`idF`) REFERENCES `frs` (`idF`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;');
        ...
        $this->addSql('CREATE TABLE `paiementa` (`idPaiement` int(8) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY,`montantP` int(10) UNSIGNED ZEROFILL NOT NULL,`dateP` date NOT NULL,`numA` int(6) UNSIGNED ZEROFILL DEFAULT NULL,`Piece` varchar(255) DEFAULT NULL,CONSTRAINT `fk_achat_paiement` FOREIGN KEY (`numA`) REFERENCES `achat` (`numA`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;');
        // ---- Structure de la table `paiementv`
        $this->addSql('CREATE TABLE `paiementv` (`idPaiementV` int(8) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY,`montantP` int(10) UNSIGNED ZEROFILL NOT NULL,`dateP` date NOT NULL,`numV` int(6) UNSIGNED ZEROFILL DEFAULT NULL,`Piece` varchar(255) DEFAULT NULL,CONSTRAINT `fk_vente_paiementv` FOREIGN KEY (`numV`) REFERENCES `vente` (`numV`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;');
        ...
        $this->addSql('CREATE TABLE `charge` (`idProd` int(3) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY,`idCharge` int(8) UNSIGNED ZEROFILL NOT NULL,`PrixP` int(8) UNSIGNED ZEROFILL DEFAULT NULL,`QteP` float(8,2) UNSIGNED ZEROFILL NOT NULL,`codeD` int(2) UNSIGNED ZEROFILL NOT NULL,`dateC` date NOT NULL,CONSTRAINT `fk_charge_produit` FOREIGN KEY (`idProd`) REFERENCES `produit` (`idProd`),CONSTRAINT `fk_depot_charge` FOREIGN KEY (`codeD`) REFERENCES `depot` (`CodeD`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;');
        // ---- Structure de la table `users`
        $this->addSql('CREATE TABLE `users` (`idUser` int(3) UNSIGNED ZEROFILL AUTO_INCREMENT PRIMARY KEY, `username` VARCHAR(255) NOT NULL,`typeu` VARCHAR(255) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;');
        //
        
        
        //  Historique inventaire

        // Historique suppréssion vente
        // -----------Vue---
        //Achatliste
